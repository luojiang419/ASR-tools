...
void main() {
  ...
  test('asr project copyWith supports clearing import directories', () {
    ...
    expect(cleared.videoDirectory, isNull);
    expect(cleared.audioDirectory, isNull);
    expect(cleared.id, project.id);
    expect(cleared.name, project.name);
  });
}
