...
void main() {
  ...
  test(
    'matchProject keeps positive headroom without false sourceClamped',
    () async {
      ...
      final segments = await DatabaseService.getSyncAudioSegments(
        results.first.id,
      );
  ...
  test(
    'matchProject creates multiple audio segments and reaches video end',
    () async {
