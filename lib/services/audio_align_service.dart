...
class AudioAlignService {
  ...
  static Future<TimelineData?> _buildSingleTimeline(
    ...
    final primarySegment = timelineSegments.isEmpty
        ? null
    ...
    return TimelineData(
      ...
      audioOriginalDurationMs: primarySegment == null
          ? (audioFile?.durationMs ?? 0)
          : primarySegment.audioDurationMs,
  ...
  static Future<List<TimelineAudioSegment>> _buildTimelineSegments(
    ...
    for (final segment in segments) {
      final audioFile = await DatabaseService.getMediaFileById(
        segment.audioFileId,
      );
