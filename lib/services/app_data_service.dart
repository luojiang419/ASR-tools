...
class AppDataService {
  ...
  static Future<Directory> executableDirectory() async {
    ...
    if (Platform.isMacOS) {
      final appBundleParent = _macOSAppBundleParent(executable);
      if (appBundleParent != null) {
        return appBundleParent;
      }
    }
  ...
  static Directory? _macOSAppBundleParent(File executable) {
