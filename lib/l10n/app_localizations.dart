...
class AppLocalizations {
  ...
  static const Map<String, String> _zh = {
    ...
    'home_empty_subtitle': '点击底部 Dock 中的"新建工程"开始',
    'home_error': '工程列表异常：{error}',
    'home_load_error': '加载工程列表失败：{error}',
    'home_search_no_result': '没有找到包含“{query}”的工程',
    ...
    'create_project_page_description':
        '创建一个新工程后，会直接进入工程工作区，继续导入素材、反解字幕并执行合板流程。',
    'rename': '重命名',
    'open_project': '打开工程',
    'delete_project': '删除工程',
    'rename_project': '重命名工程',
    'hint_new_name': '请输入新的工程名称',
    'confirm_delete': '确认删除',
    'delete_project_confirm': '确定要删除工程「{name}」吗？此操作不可恢复。',
  ...
  static const Map<String, String> _en = {
    ...
    'dock_create_project': 'New Project',
    ...
    'home_empty_subtitle':
        'Use the "New Project" item in the bottom dock to get started',
    'home_error': 'Project list error: {error}',
    'home_load_error': 'Failed to load project list: {error}',
    'home_search_no_result': 'No projects found for "{query}"',
    ...
    'create_project_page_description':
        'Create a new project and jump straight into the workspace for import, subtitle preparation, and sync.',
    'rename': 'Rename',
    'open_project': 'Open Project',
    'delete_project': 'Delete Project',
    'rename_project': 'Rename Project',
    'hint_new_name': 'Enter a new project name',
