...
class AsrProject {
  ...
  AsrProject copyWith({
    String? name,
    Object? videoDirectory = _fieldUnchanged,
    Object? audioDirectory = _fieldUnchanged,
    ...
    return AsrProject(
      id: id,
      name: name ?? this.name,
      videoDirectory: identical(videoDirectory, _fieldUnchanged)
          ? this.videoDirectory
          : videoDirectory as String?,
      audioDirectory: identical(audioDirectory, _fieldUnchanged)
          ? this.audioDirectory
          : audioDirectory as String?,
