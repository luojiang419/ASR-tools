...
class _ProjectScreenState extends ConsumerState<ProjectScreen> {
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            actions: [
              if (isDockStyle)
                IconButton(
                  tooltip: context.loc.t('project_switch_to_menu_style'),
                  onPressed: () => ref
  ...
  Widget _buildProjectSummaryCard(ProjectDetailState state) {
    final project = state.project!;
    final audioGroupCount = AudioGroupingService.groupAudioFiles(
      state.audioFiles,
    ).length;
    return Container(
        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              ...
              _buildStatusPill(
                '${context.loc.t('card_audios')} ${state.audioFiles.length} / $audioGroupCount组',
                AppTheme.accent,
              ),
            ],
          ),
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    _buildStatusPill(
                      '${context.loc.t('card_audios')} ${state.audioFiles.length} / ${AudioGroupingService.groupAudioFiles(state.audioFiles).length}组',
                      AppTheme.accent,
                    ),
  ...
  Widget _buildBottomActionBar(
    ...
    if (isDockStyle) {
      return AppBottomDockLayout(
        leading: _buildProjectHomeDockButton(context),
        center: _buildModuleDock(context, state),
        trailing: _buildBottomActionButtons(
          action,
          isEnabled,
          state,
          matchState,
  ...
  Widget _buildBottomActionButtons(
    ...
    return Wrap(
      ...
      children: [
        ...
        if (matchAction != null) matchAction,
  ...
  Widget _buildProjectHomeDockButton(BuildContext context) {
    return AppDockButton(
      item: AppDockItem(
  ...
  Widget _buildModuleDock(BuildContext context, ProjectDetailState state) {
    return AppDockPanel(
      items: List.generate(projectModules.length, (index) {
        final module = projectModules[index];
        return AppDockItem(
          label: context.loc.t(module.title),
          icon: module.icon,
          isSelected: index == state.activeSectionIndex,
          onTap: () =>
              ref.read(projectDetailProvider.notifier).setActiveSection(index),
          tooltip: context.loc.t(module.title),
          showCompletedDot: _isModuleCompleted(state, index),
        );
      }),
    );
  }
